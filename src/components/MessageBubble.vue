...
.message--card {
  ...
  border-image-repeat: stretch;
  /*
   * Card messages intentionally use the browser's live layout. When a
   * streaming response changes `message`, Vue updates this node and the
   * nine-slice border recalculates its width/height immediately.
   */
}
